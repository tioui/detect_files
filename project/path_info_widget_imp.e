...
feature {NONE}-- Initialization
	...
	frozen initialize
		...
		do
			...
			set_all_attributes_using_constants
				...
				-- Connect events.
			modify_path_button.select_actions.extend (agent modify_button_pressed)
			delete_button.select_actions.extend (agent delete_button_pressed)
	...
	frozen create_interface_objects
		...
		do
				...
				-- Create all widgets.
			create path_name_check_button
			create l_ev_cell_1
			create modify_path_button
...
feature -- Access
	...
	path_name_check_button: EV_CHECK_BUTTON
	modify_path_button, delete_button: EV_BUTTON
...
feature {NONE} -- Implementation
	...
	modify_button_pressed
			-- Called by `select_actions' of `modify_path_button'.
		deferred
		end
