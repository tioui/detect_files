note
	...
	date: "$Date: 2013-01-28 16:58:09 -0800 (Mon, 28 Jan 2013) $"
	revision: "$Revision: 91068 $"
...
feature -- Access
	...
	path_list_window_title: STRING_32
			-- `Result' is STRING_32 constant named `path_list_window_title'.
		do
			Result := path_list_window_title_cell.item
		end
	...
	main_container_minimum_width: INTEGER
			-- `Result' is INTEGER constant named `main_container_minimum_width'.
		do
			Result := main_container_minimum_width_cell.item
		end
	...
	main_container_minimum_height: INTEGER
			-- `Result' is INTEGER constant named `main_container_minimum_height'.
		do
			Result := main_container_minimum_height_cell.item
		end
	...
	quit_menu_item_text: STRING_32
			-- `Result' is STRING_32 constant named `quit_menu_item_text'.
		do
			Result := quit_menu_item_text_cell.item
		end
	...
	add_button_text: STRING_32
			-- `Result' is STRING_32 constant named `add_button_text'.
		do
			Result := add_button_text_cell.item
		end
	...
	quit_button_text: STRING_32
			-- `Result' is STRING_32 constant named `quit_button_text'.
		do
			Result := quit_button_text_cell.item
		end
	...
	delete_button_text: STRING_32
			-- `Result' is STRING_32 constant named `delete_button_text'.
		do
			Result := delete_button_text_cell.item
		end
	...
	active_check_button_tooltip: STRING_32
			-- `Result' is STRING_32 constant named `active_check_button_tooltip'.
		do
			Result := active_check_button_tooltip_cell.item
		end
	...
	start_button_text: STRING_32
			-- `Result' is STRING_32 constant named `start_button_text'.
		do
			Result := start_button_text_cell.item
		end
	...
	stop_button_text: STRING_32
			-- `Result' is STRING_32 constant named `stop_button_text'.
		do
			Result := stop_button_text_cell.item
		end
